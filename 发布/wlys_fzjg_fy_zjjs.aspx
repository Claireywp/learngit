<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_fy_zjjs, App_Web_2q7l7vdz" %>
     ...
     <div>      
          ...
          <table width="818" height=100% border="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <p align="center"><span class="style91 style92">妇幼专业委员会专家介绍</span></p>                  </td>
            </tr>
            <tr>
              <td height="3000" align="center">
              <iframe id="my"  align="center" height="3000" width="100%" runat="server" style="background-color: transparent; border-bottom-style: none; text-align: center; border-right-style: none; border-top-style: none; vertical-align: middle; border-left-style: none;" frameborder="0" scrolling="auto">
        </iframe>
                  </td>
            </tr>
        </table>
