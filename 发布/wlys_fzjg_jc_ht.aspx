<%@ page language="C#" masterpagefile="~/MasterPage0.master" autoeventwireup="true" inherits="wlys_fzjg_jc_ht, App_Web_2q7l7vdz" %>
                      ...
                      <tr>
                          ...
                          <td colspan="3" style="height: 20px; text-align: left">
                              <asp:TextBox CssClass="style100" ID="TextBox1" runat="server" Style="border-top-style: none;
                                  ...
                                  text-align: center; border-bottom-style: none;" Width="200px">检测专业委员会工作职责</asp:TextBox></td>
                      </tr>
                  <tr>
                      <td style="width: 100px; height: 20px; text-align: right">
            ...
            <tr>
              <td height="600" align="center" class="sytle101" valign="top">
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString2 %>"
                      DeleteCommand="DELETE FROM [fzjg_jc] WHERE [jieshu] = @jieshu" InsertCommand="INSERT INTO [fzjg_jc] ([jieshu], [time], [didian], [dizhi]) VALUES (@jieshu, @time, @didian, @dizhi)"
                      SelectCommand="SELECT * FROM [fzjg_jc] ORDER BY [seed] DESC" UpdateCommand="UPDATE [fzjg_jc] SET [seed] = @seed, [time] = @time, [didian] = @didian, [dizhi] = @dizhi WHERE [jieshu] = @jieshu">
                      <DeleteParameters>
                  ...
                  <tr>
                      ...
                      <td colspan="3" style="height: 20px; text-align: left">
                          <asp:TextBox ID="TextBox5" runat="server" Style="font-weight: bold; font-size: 15px;
                              ...
                              text-align: center; border-bottom-style: none" Width="171px" CssClass="style100">检测专业委员会名单</asp:TextBox></td>
                  </tr>
                  <tr>
                      <td style="width: 100px; height: 20px; text-align: right">
