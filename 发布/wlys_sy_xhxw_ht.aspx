<%@ page language="C#" masterpagefile="~/MasterPage0.master" autoeventwireup="true" inherits="wlys_sy_xhxw_ht, App_Web_2q7l7vdz" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table cellspacing="0" cellpadding="0" align="center" border="0">
        <tr>
            <td colspan="1" background="images/index_11.jpg" style="height: 31px; width: 812px;"><div align="right"><span class="style34">当前位置: <a href="wlys_sy_tztg_ht.aspx">首页</a> -&gt;<a href="wlys_sy_xhxw_ht.aspx">学会新闻</a></span></div>
            </td>
        </tr>
        </table>
</asp:Content>
  ...
  <table border="1" style="width: 809px; height: 863px">
                    ...
                    <tr>
                        <td style="width: 809px; height :600px" valign ="top" >
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="seed,time,title,id,ly" DataSourceID="SqlDataSource1" Height="304px" Width="794px" AllowPaging="True" BackColor="#FFFCE2" BorderColor="#C0FFFF" CellPadding="0" ShowHeader="False" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                <Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString %>"
                                DeleteCommand="DELETE FROM [sy_xhxw] WHERE [seed] = @seed" InsertCommand="INSERT INTO [sy_xhxw] ([time], [title], [id], [ly]) VALUES (@time, @title, @id, @ly)"
                                SelectCommand="SELECT * FROM [sy_xhxw] ORDER BY [time] DESC" UpdateCommand="UPDATE [sy_xhxw] SET [time] = @time, [title] = @title, [id] = @id, [ly] = @ly WHERE [seed] = @seed">
                                <DeleteParameters>
