<%@ page language="C#" masterpagefile="~/MasterPage0.master" autoeventwireup="true" inherits="wlys_fzjg_fy_ht, App_Web_2q7l7vdz" %>
          ...
          <table width="818" height=100% border="0" bgcolor="#FFFCE2">
            <tr>
              ...
              <div align="center">
                      ...
                      <tr>
                          ...
                          <td colspan="3" style="height: 20px; text-align: left">
                              <asp:TextBox CssClass="style100" ID="TextBox1" runat="server" Style="border-top-style: none;
                                  ...
                                  text-align: center; border-bottom-style: none;" Width="200px">妇幼专业委员会工作职责</asp:TextBox></td>
                      </tr>
                  <tr>
                      <td style="width: 100px; height: 20px; text-align: right">
                  ...
                  <table style="width: 446px; height: 90px">
                      <tr>
                          <td style="width: 100px; height: 20px; text-align: right">
                              <asp:Label ID="Label9" runat="server" CssClass="style101" Text="标题"></asp:Label></td>
                          <td colspan="3" style="height: 20px; text-align: left">
                              <asp:TextBox CssClass="style100" ID="TextBox3" runat="server" Style="border-top-style: none;
                                  border-right-style: none; border-left-style: none; background-color: transparent;
                                  text-align: center; border-bottom-style: none; " Width="200px" >妇幼专业委员会专家介绍</asp:TextBox></td>
                      </tr>
                  <tr>
                      <td style="width: 100px; height: 20px; text-align: right">
                          <asp:Label ID="Label10" runat="server" CssClass="style101" Text="文件"></asp:Label></td>
                      <td colspan="3" style="height: 20px; text-align: left">
                          <asp:FileUpload ID="FileUpload3" runat="server"  CssClass="style101" /></td>
                  </tr>
                  <tr>
                      <td style="width: 100px; height: 20px">
                      </td>
                      <td align="center" colspan="3" style="height: 20px; text-align: left">
                          <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" CssClass="style101"
                              Text="更新" Width="70px" />
                          </td>
                  </tr>
              </table>
            ...
            <tr>
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString2 %>"
                      DeleteCommand="DELETE FROM [fzjg_fy] WHERE [jieshu] = @jieshu" InsertCommand="INSERT INTO [fzjg_fy] ([jieshu], [time], [didian], [dizhi]) VALUES (@jieshu, @time, @didian, @dizhi)"
                      SelectCommand="SELECT * FROM [fzjg_fy] ORDER BY [seed] DESC" UpdateCommand="UPDATE [fzjg_fy] SET [seed] = @seed, [time] = @time, [didian] = @didian, [dizhi] = @dizhi WHERE [jieshu] = @jieshu">
                      <DeleteParameters>
                  ...
                  <tr>
                      ...
                      <td colspan="3" style="height: 20px; text-align: left">
                          <asp:TextBox ID="TextBox5" runat="server" Style="font-weight: bold; font-size: 15px;
                              ...
                              text-align: center; border-bottom-style: none" Width="171px" CssClass="style100">妇幼专业委员会名单</asp:TextBox></td>
                  </tr>
                  <tr>
                      <td style="width: 100px; height: 20px; text-align: right">
