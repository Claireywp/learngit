<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_fy, App_Web_2q7l7vdz" %>
...
<table cellspacing="0" cellpadding="0" width="1004" align="center" border="0">
    ...
    <a href="wlys_fzjg_fy_zjjs.aspx">专家介绍</a> 
     ...
     <div>      
          ...
          <table width="818" border="0" bgcolor="#FFFFFF">
            <tr>
              <td class="style42" style="height: 31px"> 
              <p align="center"><span class="style92 style91">妇幼专业委员会工作职责</span></p>                  </td>
            </tr>
            <tr>
              <td height="700" align="center" valign="top">
               <iframe id="my"  align="center" height="700" width="100%" runat="server" style="background-color: transparent; border-bottom-style: none; text-align: center; border-right-style: none; border-top-style: none; vertical-align: middle; border-left-style: none;" frameborder="0">
        </iframe>
