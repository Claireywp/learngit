<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_yx_md, App_Web_2q7l7vdz" %>
            ...
            <tr>
              ...
              <div align="center">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString %>"
                          SelectCommand="SELECT * FROM [fzjg_yx] ORDER BY [seed] DESC" DeleteCommand="DELETE FROM [fzjg_yx] WHERE [jieshu] = @jieshu" InsertCommand="INSERT INTO [fzjg_yx] ([jieshu], [time], [didian], [dizhi]) VALUES (@jieshu, @time, @didian, @dizhi)" UpdateCommand="UPDATE [fzjg_yx] SET [seed] = @seed, [time] = @time, [didian] = @didian, [dizhi] = @dizhi WHERE [jieshu] = @jieshu">
                          <DeleteParameters>
