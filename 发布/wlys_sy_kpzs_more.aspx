<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_sy_kpzs_more, App_Web_2q7l7vdz" %>
        ...
        <table height="200" cellspacing="0" cellpadding="0" width="270" border="0" >
          ...
          <tr>
            <td class="top_userlogin" valign="top" style="width: 368px; height: 88px;"><table width="267" height="151" border="0">
              <tr>
                <td height="42" style="width: 133px"><a href="http://www.jlstnet.net/"><img src="images/&#31185;&#21327;.jpg" alt="" width="130" height="40" border="0"/></a></td>
                <td width="127"><a href="http://mzt.jl.gov.cn/"><img src="images/&#27665;&#25919;&#21381;.jpg" alt="" width="127" height="40" border="0"/></a></td>
              </tr>
              <tr>
                <td height="35" style="width: 133px"><a href="http://www.pukang.cn/"><img src="images/&#20581;&#24247;&#20803;&#32032;&#32593;.jpg" alt="" width="130" height="40" border="0"/></a></td>
                <td><a href="http://www.tesd.cn/"><img src="images/&#23665;&#19996;&#20803;&#32032;.jpg" alt="" width="127" height="40" border="0"/></a></td>
              </tr>
              <tr>
                <td height="38" style="width: 133px"><a href="http://www.zhte.org/"><img src="images/&#23433;&#24509;&#20803;&#32032;.jpg" alt="" width="130" height="40" border="0"/></a></td>
                    ...
                    <td style="width: 740px; " valign ="top" >
                        <table style="width: 100% " >
                            <tr>
                                <td width="100%"  background="images/index_11.jpg" style="height: 29px"><div align="right"><span class="style34">当前位置: <a href="wlys_sy.aspx">首页</a> -&gt;<a href="wlys_sy_kpzs_more.aspx">科普知识</a></span></div></td>
                            </tr>
                            <tr>
                                <td style="width: 100% ; height: 606px;" valign ="top"  align ="left">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="seed,time,title,id,ly"
                                        DataSourceID="SqlDataSource1"  Width="100%" OnRowCommand="GridView1_RowCommand" ShowHeader="False" GridLines="None" AllowPaging="True" PageSize="15">
                                        <Columns>
                                            <asp:TemplateField ShowHeader="False" >
                                                <ItemTemplate  >
                                                    <asp:Image ID="Image1" runat="server" Height="30px" ImageUrl="~/images/biao01.gif"
                                                        Width="21px"  />&nbsp; &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False"
