<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_yaox, App_Web_2q7l7vdz" %>
     ...
     <div>      
          ...
          <table width="818" height=100% border="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <p align="center"><span class="style91 style92">药学专业委员会工作职责</span></p>                  </td>
            </tr>
            <tr>
              <td height="700" align="center">
               <iframe id="my"  align="center" height="700" width="100%" runat="server" style="background-color: transparent; border-bottom-style: none; text-align: center; border-right-style: none; border-top-style: none; vertical-align: middle; border-left-style: none;" frameborder="0" scrolling="auto">
        </iframe>
