<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_yx, App_Web_2q7l7vdz" %>
...
<table cellspacing="0" cellpadding="0" width="1004" align="center" border="0">
        <tr>
            ...
            <td colspan="3" width="812" background="images/index_11.jpg" style="height: 31px"><div align="right"><span class="style34">当前位置: <a href="index.htm">首页</a> -&gt;<a href="wlys_fzjg_jc.aspx">分支机构</a></span></div>
            </td>
        </tr>
        <tr>
     ...
     <div>      
          ...
          <table width="818" height=100% border="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <p align="center"><span class="style91 style92">医学专业委员会工作职责</span></p>                  </td>
            </tr>
            <tr>
              <td height="700" align="center">
               <iframe id="my"  align="top" height="700" width="100%" runat="server" style="background-color: transparent; border-bottom-style: none; text-align: center; border-right-style: none; border-top-style: none; vertical-align: middle; border-left-style: none;" frameborder="0" scrolling="auto">
        </iframe>
