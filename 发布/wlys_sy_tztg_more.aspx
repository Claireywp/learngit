<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_sy_tztg_more, App_Web_2q7l7vdz" %>
                ...
                <td height="38"><a href="http://www.zhte.org/"><img src="images/&#23433;&#24509;&#20803;&#32032;.jpg" alt="" width="130" height="40" border="0"/></a></td>
                    ...
                    <td style="width: 740px; " valign ="top" >
                        <table style="width: 100%">
                            <tr>
                                <td width="100%"  background="images/index_11.jpg" style="height: 29px"><div align="right"><span class="style34">当前位置: <a href="wlys_sy.aspx">首页</a> -&gt;<a href="wlys_sy_tztg_more.aspx">通知通告</a></span></div></td>
                            </tr>
                            <tr>
                                <td style="width: 100% ; height: 606px;" valign ="top"  align ="left">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="seed,time,title,id,ly"
                                        DataSourceID="SqlDataSource1" Height="102%" Width="100%" OnRowCommand="GridView1_RowCommand" ShowHeader="False" AllowPaging="True" GridLines ="None" PageSize="15" >
                                        <Columns>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString %>"
                                        SelectCommand="SELECT * FROM [sy_tztg]"></asp:SqlDataSource>
                                </td>
                            </tr>
                        </table>
                    </td>
