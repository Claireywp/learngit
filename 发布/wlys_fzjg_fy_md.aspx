<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="wlys_fzjg_fy_md, App_Web_2q7l7vdz" %>
            ...
            <tr>
              ...
              <div align="center">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wlysConnectionString %>"
                          SelectCommand="SELECT * FROM [fzjg_fy] ORDER BY [seed] DESC" DeleteCommand="DELETE FROM [fzjg_fy] WHERE [jieshu] = @jieshu" InsertCommand="INSERT INTO [fzjg_fy] ([jieshu], [time], [didian], [dizhi]) VALUES (@jieshu, @time, @didian, @dizhi)" UpdateCommand="UPDATE [fzjg_fy] SET [seed] = @seed, [time] = @time, [didian] = @didian, [dizhi] = @dizhi WHERE [jieshu] = @jieshu">
                          <DeleteParameters>
                  ...
                  <table style="width: 395px; height: 1px">
                      <tr>
                          <td colspan="2" align="center" valign="top">
                              ...
                              <asp:TextBox ID="TextBox1" runat="server" Style="border-top-style: none; border-right-style: none; border-left-style: none;
                                  background-color: transparent; text-align: center; border-bottom-style: none" CssClass="style42"
                      ...
                      <tr>
                          <td style="width: 100%; text-align: right;" align="center" valign="top">
                              <asp:TextBox ID="TextBox2" runat="server" Style="border-top-style: none; border-right-style: none; border-left-style: none;
                                  background-color: transparent; border-bottom-style: none" CssClass="style102" Width="120px"></asp:TextBox></td>
                          <td style="width: 100%; text-align: left;">
                              <asp:TextBox ID="TextBox3" runat="server" Style="border-top-style: none; border-right-style: none; border-left-style: none;
                                  background-color: transparent; text-align: center; border-bottom-style: none" CssClass="style102" Width="91px"></asp:TextBox></td>
                      </tr>
                  </table>
                  <h2 id="a">
                <iframe id="my" class="style52"  align="center" height="500" width="100%" runat="server" style="background-color: transparent; border-bottom-style: none; text-align: center; border-right-style: none; border-top-style: none; vertical-align: middle; border-left-style: none;" frameborder="0" scrolling="auto">
        </iframe>
        </h2>
